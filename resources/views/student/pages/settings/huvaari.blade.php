    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-4 xxl:col-span-3 flex lg:block flex-col-reverse">
            <div class="intro-y box mt-5">
                ...
                <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                    <a class="flex items-center text-theme-1 dark:text-theme-10 font-medium" href="{{route('student-settings-huvaari')}}">
        ...
        <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
            ...
            <form class="validate-form-teacher" action="{{ route('student-teachers-save') }}" method="post" enctype="multipart/form-data">
            @csrf
