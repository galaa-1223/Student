...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
            <form class="validate-form" action="{{ route('student-teachers-save') }}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-span-12 xl:col-span-4">
                            <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5">
                                <div class="w-40 h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                    <img id="preview-image" class="rounded-md" alt="student systems 1.0" src="{{ asset('dist/images/Blank-avatar.png') }}">
            ...
            <div class="intro-y box lg:mt-5">
                ...
                <div class="p-5">
                    ...
                    <div class="flex justify-end mt-4">
                        <button type="button" onclick="window.location.href='{{ route('student-teachers') }}'" class="button w-40 bg-theme-6 text-white ml-5">{{ __('site.cancel') }}</button> 
