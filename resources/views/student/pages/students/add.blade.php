...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
            <form class="validate-form" action="{{ route('student-students-save') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="intro-y box lg:mt-5">
                ...
                <div class="p-5">
                    ...
                    <div class="flex justify-end mt-4">
                        <button type="button" onclick="window.location.href='{{ route('student-students') }}'" class="button w-40 bg-theme-6 text-white ml-5">{{ __('site.cancel') }}</button> 
